...
std::string getCurrentTime();       // 获取系统时间（聊天信息需要添加时间信息）
...
void help(int fd = 0, std::string str = ""); // "help" command handler
void chat(int, std::string);                 // "chat" command handler
void addfriend(int, std::string);            // "addfriend" command handler
void creategroup(int, std::string);          // "creategroup" command handler
void addgroup(int, std::string);             // "addgroup" command handler
void groupchat(int, std::string);            // "groupchat" command handler
void logout(int, std::string);               // "logout" command handler
...
/**
 * @description: "addfriend" command handler
 * @param {int} clientfd
 * @param {string} str
 * @return {*}
 */
...
/**
 * @description: "creategroup" command handler  groupname:groupdesc
 * @param {int} clientfd
 * @param {string} str
 * @return {*}
 */
...
/**
 * @description: "addgroup" command handler
 * @param {int} clientfd
 * @param {string} str
 * @return {*}
 */
...
/**
 * @description: "groupchat" command handler   groupid:message
 * @param {int} clientfd
 * @param {string} str
 * @return {*}
 */
...
/**
 * @description: "loginout" command handler
 * @param {int} clientfd
 * @return {*}
 */
...
/**
 * @description: 获取系统时间（聊天信息需要添加时间信息）
 * @param {*}
 * @return {*}
 */
