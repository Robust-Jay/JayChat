 ...
 * @LastEditTime: 2022-02-28 20:07:20
 * @LastEditors: Han Liu
 * @Description:
...
namespace JayChat
{
    ...
    ChatService::ChatService()
    {
        ...
        __msgHandlerMap.insert({ADD_FRIEND_MSG, std::bind(&ChatService::addFrient, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3)});
    }
     ...
     * @return {*}
     */
    void ChatService::addFrient(const TcpConnectionPtr &conn, json &js, Timestamp time)
    {
